                  ...
                  <div class="d-flex gap-3 gap-xl-0 align-items-center">
                     ...
                     <div class="logo-default">
                         <a class="navbar-brand text-primary" href="index.html">                                              
                            <img src="assets/images/favicon.png" alt="imdb logo" class="img-fluid logo  ">
                         </a>
                     </div>
                      ...
                      <ul class="navbar-nav iq-nav-menu  list-unstyled" id="header-menu">
                        ...
                        <li class="nav-item">
                          ...
                          <ul class="sub-nav collapse  list-unstyled" id="features">
                            <li class="nav-item">
                              <a class="nav-link " href="restricted-content.html"> Action </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link " href="related-merchandise.html"> Avanture </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link " href="playlist.html"> Horreur </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link " href="geners.html"> Drôle </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link " href="cast.html"> Drame </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link " href="tags.html"> Documentaire </a>
                            </li>
                          </ul>
                        </li>
                        <li class="nav-item">
                          ...
                          <ul class="sub-nav collapse  list-unstyled" id="pages">
                            <li class="nav-item">
                              <a class="nav-link " href="about-us.html"> Populaire </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link " href="contact-us.html"> Jeunes </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link " href="faq.html"> Adultes </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link " href="privacy-policy.html"> Tout </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" data-bs-toggle="collapse" href="#error-page" role="button" aria-expanded="false" aria-controls="error-page">
                                <span class="item-name">Ajouter Son Acteur</span>
                                <span class="menu-icon">
                        ...
                        <li class="nav-item">
                          ...
                          <ul class="sub-nav collapse  list-unstyled" id="pages">
                            <li class="nav-item">
                              <a class="nav-link " href="about-us.html"> Films </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link " href="contact-us.html"> Acteurs </a>
                            </li>
                  ...
                  <div class="col-lg-7 col-md-12">
                     ...
                     <div class="trending-list RightAnimate-three">
                        <div class="text-primary genres fw-500"> Genres:
                           <a href="view-all-movie.html" class="fw-normal text-white text-decoration-none ms-2"> Action
                           </a>
                        </div>
                        <div class="text-primary tag fw-500"> Tag:
                           <a href="view-all-movie.html" class="fw-normal text-white text-decoration-none ms-2"> Action,
                           </a>
                           <a href="view-all-movie.html" class="fw-normal text-white text-decoration-none ms-2">
                              Adventure, </a>
                           <a href="view-all-movie.html" class="fw-normal text-white text-decoration-none ms-2"> Horror
                           </a>
                        </div>
                     </div>
      ...
      <div class="swiper-slide slide s-bg-1 p-0">
         ...
         <div class="container-fluid position-relative h-100">
            <div class="slider-inner h-100">
               <div class="row align-items-center iq-ltr-direction h-100">
                  <div class="col-lg-7 col-md-12">
                     <h1 class="texture-text big-font letter-spacing-1 line-count-1 text-uppercase mb-0 RightAnimate">
                        Bumblebee </h1>
                     <div class="d-flex flex-wrap align-items-center r-mb-23 RightAnimate-two">
                        <div class="slider-ratting d-flex align-items-center">
                           <ul
                     ...
                     <div class="swiper-slide">
                        ...
                        <div class="description">
                           <div class="block-description">
                              ...
                              <p class="t-0 mb-3 line-count-2">The point of using Lorem Ipsum is that it has a
                                 more-or-less normal
                           ...
                           <div class="card-description with-transition">
                             <div class="cart-content">
                               <div class="content-left">
                                 ...
                                 <div class="movie-time d-flex align-items-center my-2">
                                   <span class="movie-time-text font-normal">3hr : 0min</span>
                                 </div>
                               </div>
                               <div class="watchlist">
                                 <a class="watch-list-not" href="playlist.html">
...
<section id="parallex" class="parallax-window bg-attachment-fixed"
   style="background:url(assets/images/parallax/parallex.html) fixed;">
         ...
         <div class="col-xl-7 col-lg-12 col-md-12 mt-5 mt-xl-0">
            <div class="parallax-img">
               <a href="movie-detail.html">
                  <img src="assets/images/parallax/parallex.html" class="img-fluid w-100" loading="lazy"
                     alt="bailey">
               </a>
            </div>
         </div>
